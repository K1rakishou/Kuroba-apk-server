...
data class Commit(
  ...
  val apkUuid = ApkUuid(String.format("%d_%s", apkVersion.version, commitHash.hash))

  fun asString(): String {
    return String.format("%s; %s; %s", commitHash.hash, committedAt.toString(), description)
  }
...
// uuid == apkVersion + firstCommitHash, i.e.: 404040-1234567890abcdef
inline class ApkUuid(val uuid: String)